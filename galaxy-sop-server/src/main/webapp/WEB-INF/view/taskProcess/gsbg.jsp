...
<div class="btm">
	...
	<ul>
		<li><a href="javascript:;" id="show-gqjg-upload-btn">上传股权交割凭证</a></li>
		<li><a href="javascript:;" id="show-gsbg-upload-btn">上传工商变更凭证</a></li>
...
$(function(){
	loadRows();
	loadRelatedData();
	$("#show-gqjg-upload-btn").click(function(){
		showUploadPopup("fileWorktype:7");
	});
	$("#show-gsbg-upload-btn").click(function(){
		showUploadPopup("fileWorktype:8");
	});
});
function loadRows()
{
	...
	var data = {
		"projectId":"${projectId}",
		"fileworktypeList":["fileWorktype:7","fileWorktype:8"]
	};
...
function showUploadPopup(fileWorktype)
{
	$.popup({
...
function initForm(_dialog,fileWorktype)
{
