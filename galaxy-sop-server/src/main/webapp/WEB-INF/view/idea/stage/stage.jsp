            ...
            <!-- 创意基本信息 -->
              <div class="block block_t show aa"  data-tab="con" id="ideaDetail">
                  <div class="btnbox_f1 btnbox_m clearfix">
                    <button class="pubbtn fffbtn" id="claimt" resource-mark="idea_claim" style="display:none" href="<%=path %>/galaxy/idea/goClaimtcPage" data-btn="claim">认领</button>
		...
		<!-- 创建立项会  ideaProgress:3 -->
              <div class="block block_t" data-tab="con"  id="ideaProgress_3_con">
                ...
                <div id="options_point3" class="btnbox_f btnbox_f1 btnbox_m clearfix">
                    ...
                    <button class="pubbtn fffbtn lpubbtn disabled" href="<%=path %>/galaxy/idea/showCreateProjectDialog" data-btn="create" disabled="disabled">创建成项目</button>
