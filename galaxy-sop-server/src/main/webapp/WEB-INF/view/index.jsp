...
java.util.Map<String, Object> endpointMap = new com.google.gson.Gson().fromJson(endpoint,new com.google.gson.reflect.TypeToken<T><java.util.Map<String, Object>>() {}.getType()); 
