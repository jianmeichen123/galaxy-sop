...
<!-- 富文本编辑器 -->
<link id="f" href="<%=request.getContextPath() %>/ueditor/themes/default/css/umeditor.css" type="text/css" rel="stylesheet">
...
$('#platform_jxkh_more').click(function(){
    window.location.href=path + "/galaxy/report/kpi?guid="+userId+"&sid="+sessionId;
