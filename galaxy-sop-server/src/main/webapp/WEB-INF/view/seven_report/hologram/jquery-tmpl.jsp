					...
					<div class="mb_16">
					    <dl class="h_edit_txt clearfix">
							...
							{{else type=="16"}}
								...
								{{/each}}
							{{else type=="19"}}
								<dd><input type="text" data-title-id="\${id}"  data-type="\${type}" data-valrule="\${valRule}" data-valrulemark="\${valRuleMark}" placeholder="\${placeholder}" data-valRuleFormula="\${valRuleFormula}" data-must="\${isMust}" /></dd>
								<dd>\${content}</dd>
							{{else type=="20"}}
								<dd><input type="text" data-title-id="\${id}"  data-type="\${type}" data-valrule="\${valRule}" data-valrulemark="\${valRuleMark}" placeholder="\${placeholder}"  data-must="\${isMust}"/></dd>
								<dd>\${content}</dd>
