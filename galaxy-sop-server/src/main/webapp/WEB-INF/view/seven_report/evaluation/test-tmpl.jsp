				...
				{{if sign!=3&&sign!=1}}
					...
					{{else type=="8"}}
						...
						<td class="condition" onmouseover="mouserover(this)"  onmouseout="mouseout(this)">
							...
							<div class="align_left"><p class="title-value type_8 mare_text" data-type="\${type}" data-title-id="\${titleId}" data-relate-id="\${id}">未填写</p><em class="packup">收起</em><em class="detail"><i>...</i>展开</em></div>										
						</td>
					{{else type=="9"}}
						<!-- 固定表格 -->
						<td class="condition" onmouseover="mouserover(this)" onmouseout="mouseout(this)">
					...
					{{else type=="16"}}
						<td class="condition" onmouseover="mouserover(this)" onmouseout="mouseout(this)">
							<div class="align_left content_16"><p class="title-value type_8 mare_text" data-code="\${code}" data-type="\${type}" data-title-id="\${titleId}" data-relate-id="\${id}">未填写</p><em class="packup">收起</em><em class="detail"><i>...</i>展开</em></div>
							<span class="editPic" e-type="cover_pop" onclick="typeEdit(this)" attr-id="\${relateCode}"></span>
						</td>
					{{else type=="18"}}
						...
						<td colspan="4"  class="td_15">
							<div>
								<table class="table_inner">
									...
									<tr>
										<td class="condition" onmouseover="mouserover(this)"  onmouseout="mouseout(this)">
											<div class="align_left"><p class="title-value type_8 mare_text" data-type="\${type}" data-title-id="\${titleId}" data-relate-id="\${titleRelateId}" data-sub-id="\${subId}">未填写</p><em class="packup">收起</em><em class="detail"><i>...</i>展开</em></div>
											<span class="editPic" e-type="small_pop" onclick="typeEdit(this)" attr-id="\${relateCode}"  ></span>
										</td>
...
<script id="edit_tmpl1" type="text/x-jquery-tmpl">
	<div class="div_tmpl">
		{{if type==8 || type==15}}
			{{if id==1004 || id==9004}}
			<textarea id='myTextarea' data-content="\${content}" data-id="\${id}" maxlength="\${valRuleMark}" data-must="\${isMust}">\${placeholder}</textarea>
			{{else id==1006 || id==9006}}
			<textarea id='myTextarea' data-content="\${content}" data-id="\${id}" maxlength="\${valRuleMark}" data-must="\${isMust}"></textarea>
			{{else}}
						...
						<td class="condition" onmouseover="mouserover(this)" onmouseout="mouseout(this)">
							...
							{{else type=="7"}}
								<dd class="fl_none clearfix">
								 ...
								 <ul class="h_imgs"  id="edit-\${id}">
									<li class="h_imgs_add" id="h_imgs_add_\${id}"><input type="file" onchange="img_fun(this)"  accept="image/png,image/gif,image/jpeg,image/jpg,image/x-ms-bmp, image/bmp" file-title-id="\${id}" id="selected_file_\${id}"></li>
								</ul>
								</dd>
