						...
						<td class="condition" onmouseover="mouserover(this)" onmouseout="mouseout(this)">
							...
							{{else type=="7"}}
								<dd class="fl_none clearfix">
								 ...
								 <ul class="h_imgs"  id="edit-\${id}">
									<li class="h_imgs_add" id="h_imgs_add_\${id}"><input type="file" onchange="img_fun(this)"  accept="image/png,image/gif,image/jpeg,image/jpg,image/BMP,image/x-ms-bmp" file-title-id="\${id}" id="selected_file_\${id}"></li>
								</ul>
								</dd>
