...
<c:set var="isThyy" value="${fx:hasRole(20)}" scope="request"/>  
			...
			<div class="tq_div">
				...
				<ul class="sev_report clearfix">
					...
					<li class="seven_link2 gray_link2" onclick="seven_link(2);">
					...
					<li class="seven_link3 gray_link3" onclick="seven_link(3);">
					...
					<li class="seven_link4 gray_link4" onclick="seven_link(3);">
						<img src="<%=path %>/img/seven_report/jd_gray.png" />
						<span>决策报告</span>	
					</li>
					...
					<li class="seven_link5 gray_link5" onclick="seven_link(5);">
					...
					<li class="seven_link6 gray_link6" onclick="seven_link(6);">
					...
					<li class="seven_link7 gray_link7" onclick="seven_link(7);">
