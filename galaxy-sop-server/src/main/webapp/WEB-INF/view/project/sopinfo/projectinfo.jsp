				...
				<div class="basic_on">
					<div class="compile_on_center">
				       ...
				       <table width="100%" cellspacing="0" cellpadding="0" class="new_table">
				            ...
				            <tr>
				                <td><span class="new_color_gray">出让股份：</span><span class="new_color_black"><input class="new_nputr_number" size="20" id="project_share_ratio_edit" allowNULL="yes" valType="OTHER" regString="^([1-9][0-9](\.\d{1,4})?)$" msg="<font color=red>*</font>0到100之间的四位小数"/>　&nbsp;%</span></td>
				            </tr>
				        </table>
				        <!--实际投资-->
				        <div class="new_r_compile new_bottom_color">
				        ...
				        <table width="100%" cellspacing="0" cellpadding="0" class="new_table">
				            ...
				            <tr>
				                <td><span class="new_color_gray">股权占比：</span><span class="new_color_black"><input class="new_nputr_number" size="20" id="finalShareRatio_edit" allowNULL="yes" valType="OTHER" regString="^([1-9][0-9](\.\d{1,4})?)$" msg="<font color=red>*</font>0到100之间的四位小数"/>&nbsp;　%</span></td>
				     		</tr>
				        </table>
				    </div>
				</div>
