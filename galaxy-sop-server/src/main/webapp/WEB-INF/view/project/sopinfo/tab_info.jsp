	...
	<div class="basic_on">
		...
		<div class="compile_on_center">
	       ...
	       <table width="100%" cellspacing="0" cellpadding="0" class="new_table">
	            ...
	            <tr>
	                <td><span class="basic_span"><em class="red">*</em>出让股份：</span><span class="new_color_black"><input class="new_nputr_number" size="20" id="project_share_ratio_edit" />　&nbsp;%</span></td>
	            </tr>
	              </table>
	        <!--实际投资-->
	        <div class="new_r_compile new_bottom_color">
