				...
				<table width='100%' cellspacing='0' cellpadding='0' class="edit_basic_table">
					...
					<tr>
						<td>
							...
							<div id="dropdown"> 
								<input class="input_select" type="text" value="请选择" id="industry_own_sel" name="industryOwn" required data-msg-required="<font color=red>*</font>行业归属不能为空" aria-required="true"/> 
					...
					<tr>
						<td>
							...
							<div id="dropdown"> 
								<input class="input_select" type="text" value="请选择" id="finance_status_sel" name="financeStatus" required data-msg-required="<font color=red>*</font>融资轮次不能为空" aria-required="true" data-title-id="1108" data-type="14"/> 
									<ul class='base_select_ul'> 
										<li>企业服务</li> 
										<li>数字娱乐</li> 
										<li>互联网教育</li> 
					...
					<tr>
						<td>
							...
							<div id="dropdown"> 
								<input class="input_select" type="text" value="请选择" name="projectSource" required data-msg-required="<font color=red>*</font>项目来源不能为空" aria-required="true"/> 
									<ul class='base_select_ul'> 
										<li>企业服务</li> 
										<li>数字娱乐</li> 
										<li>互联网教育</li> 
...
/* 	if(getCookieValue('backListOperation')=='7'){
	...
	function addInputsRow(i){
	     var inputsRow='<div class="block_inputs">'
	          +'<span><input placeholder="填写机构名称" class="name" name="deliveryName_'+addInputs_i+'" required maxLength="50" data-msg-required="<font color=red>*</font>必填，且不超过50字" data-rule-delivery="true" data-msg-delivery="<font color=red>*</font>不能为空"/></span>'
	          +'<span><input placeholder="填写投资金额（万元）" name="deliveryAmount_'+addInputs_i+'" required data-rule-amount="true" data-msg-required="<font color=red>*</font>支持0-1000000的四位小数" data-msg-amount="<font color=red>*</font>支持0-1000000的四位小数"/></span>'
	          +'<span><select><option value="currency:0">人民币</option><option value="currency:1">美元</option></select></span>'
	          +'<span><input placeholder="填写占股比例（%）" name="deliveryShareRatio_'+addInputs_i+'" required data-rule-share="true" data-msg-required="<font color=red>*</font>0到100之间的两位小数" data-msg-share="<font color=red>*</font>0到100之间的两位小数"/></span>'
