			...
			<c:if test="${isEditable}">
				<div class="top clearfix border_bottom">
					...
					<div class="btnbox_f btnbox_f1 clearfix borderRadius">
						...
						<a id="" href="javascript:;" onclick="pagePop(this)" urlCode="" dnCode="teamInfo" data-href='' class="add_pro DN_btn lightbg" >参考信息</a>
					</div>
				</div>
			</c:if>
		</div>
		...
		<div class="title_3">
	        ...
	        <c:if test="${isEditable}">
	         	<span class="new_fctbox">
	            	...
	            	<a href="javascript:;" class="DN_btn" onclick="pagePop(this)" dnCode="legalInfo" urlCode="" data-name="basic">参考信息</a>
	         	</span>
	        </c:if>
	    </div>
        ...
        <!--按钮-->
	       <c:if test="${isEditable}">
	          <div class="btnbox_f btnbox_f1 clearfix borderRadius">
	              ...
	              <a id="" href="javascript:;"  onclick="pagePop(this)" urlCode="" dnCode="equityInfo" class="add_pro DN_btn lightbg" >参考信息</a>
	          </div>
	        </c:if>
	    </div>
			</div>
		        ...
		        <!--按钮-->
			       <c:if test="${isEditable}">
			          <div class="btnbox_f btnbox_f1 clearfix borderRadius">
			              ...
			              <a id="" href="javascript:;" onclick="pagePop(this)" dnCode="financeInfo" urlCode="" class="add_pro DN_btn lightbg" >参考信息</a>
			          </div>
			        </c:if>
		    </div>
			</div>
