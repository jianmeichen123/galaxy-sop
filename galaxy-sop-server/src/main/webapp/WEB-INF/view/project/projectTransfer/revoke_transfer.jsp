        ...
        <div class="role_all">
        	...
        	<input type="hidden" name="projectId" value="">
                <li>
                    ...
                    <div class="fl"><textarea style="width:305px;" class="role_toolTip_area" name="undoReason" maxlength="100" ></textarea></div>
                ...
                <li>
                    ...
                    <a href="javascript:;" class="register_all_affrim fl" id="revokeTransfer" >确认</a>
