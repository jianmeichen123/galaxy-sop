    ...
    <div class="form clearfix">
        <div class="role_all">
        	...
        	<input type="hidden" name="projectId" value="">
                <li>
                    <div class="fl width_150 align_r" style="margin-right:10px;">拒接原因：</div>
                    <div class="fl"><textarea style="width:305px;padding:7px 5px;" class="role_toolTip_area" name="refuseReason" maxlength="100"></textarea></div>
                ...
                <li>
                    ...
                    <a href="javascript:;" class="register_all_affrim fl" id="refuseReason" >确认</a>
