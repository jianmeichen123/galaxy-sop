  ...
  <div class="form clearfix">
      ...
      <dl class="fmdl fl">
       ...
       <dl class="fmdl fl">
        ...
        <dd><input type="text" name="financeAmount" value="${share.financeAmount}" class="txt" allowNULL="no" valType="LIMIT_11_NUMBER" msg="<font color=red>*</font>支持两位小数"/><span>&nbsp;万元</span></dd>
      </dl>
      <dl class="fmdl fl">
