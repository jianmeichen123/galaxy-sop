...
<div class="addmentc">
  ...
  <div class="form clearfix">
    <div class="left">
      ...
      <dl class="fmdl">
        <dt>占比：</dt>
        <dd><input type="text" name="sharesRatio" value="${share.sharesRatio }" class="percentTxt txt" valType="OTHER" regString="^(\d{1,2}(\.\d{1,3})?|100(\.[0]{1,3}))$" msg="<font color=red>*</font>0-100间数字"/><span>%</span></dd>
      </dl> 
    </div>
    <div class="right">
      <dl class="fmdl">
