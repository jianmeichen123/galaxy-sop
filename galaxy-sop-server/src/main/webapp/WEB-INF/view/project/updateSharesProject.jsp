...
<div class="title_bj">编辑股权结构</div>
  ...
  <div class="form clearfix" id="edit_share">
      ...
      <dl class="fmdl">
        <dt>股权占比：</dt>
        <dd><input type="text" name="sharesRatio" id="sharesRatio" value="${share.sharesRatio }" class="txt fl" valType="OTHER" allowNULL="yes" regString="^(\d{1,2}(\.\d{1,2})?|100(\.[0]{1,2})|100)$" msg="<font color=red>*</font>0-100之间的两位小数"/><span>&nbsp;%</span></dd>
      </dl> 
      <%-- <dl class="fmdl">
        <dt>获取方式：</dt>
