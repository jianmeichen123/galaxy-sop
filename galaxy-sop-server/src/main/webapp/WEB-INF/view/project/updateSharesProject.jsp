...
<div class="title_bj">编辑股权结构</div>
  ...
  <div class="form clearfix">
      <dl class="fmdl fl">
        ...
        <dd><input type="text" name="sharesOwner" value="${share.sharesOwner }" class="txt" valType="OTHER" regstring="^[^\s](.{0,49})$" msg="<font color=red>*</font>不能为空且字符长度最大50"/></dd>
      </dl>
      <dl class="fmdl fl">
        <dt><em class="red">*</em>&nbsp;所有权人类型：</dt>
        <dd><input type="text" name="sharesType" value="${share.sharesType}" class="txt" valType="OTHER" regstring="^[^\s](.{0,49})$" msg="<font color=red>*</font>不能为空且字符长度最大50"/></dd>
      </dl>  
      <dl class="fmdl fl">
