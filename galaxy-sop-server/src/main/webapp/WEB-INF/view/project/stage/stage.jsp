  ...
  <a href="javascript:;" data-close="close" class="close null">关闭</a>
      ...
      <!-- tab标签 -->
        <ul class="tablink">
            ...
            <li data-tab="nav"><a href="javascript:;">接触访谈</a></li>           
            <li data-tab="nav"><a href="javascript:;">内部评审</a></li>           
            <li data-tab="nav"><a href="javascript:;">CEO评审</a></li>           
            <li data-tab="nav"><a href="javascript:;">立项会</a></li>           
            <li data-tab="nav"><a href="javascript:;">投资意向书</a></li>           
            <li data-tab="nav"><a href="javascript:;">尽职调查</a></li>           
            <li data-tab="nav"><a href="javascript:;">投决会</a></li>           
            <li data-tab="nav"><a href="javascript:;">投资协议</a></li>           
            <li data-tab="nav"><a href="javascript:;">股权交割</a></li>           
        ...
        <!-- 项目基本信息 -->
          <div class="block block2 show"  data-tab="con">
            <dl>
              <dt>项目概述</dt>
              <dd class="fctbox">
                <a href="javascript:;" class="ico1 f1">编辑</a><a href="javascript:;" class="ico1 f2">查看详情</a>
              </dd>
            </dl>                
            <dl>
              <dt>商业模式</dt>
          ...
          <div class="block" data-tab="con">
            ...
            <div class="searchbox">
              <div class="show_more">
                <a href="#" class="blue open">展开</a>
                <a href="#" class="blue searchbox_hidden pack">收起</a>
              </div>
              <div class="default">
                 <dl class="fmdl fmmr fmmm">
                   <dt>文件来源：</dt>
                   <dd><label for=""><input type="radio">不限</label></dd>
                   <dd><label for=""><input type="radio">内部</label></dd>
                   <dd><label for=""><input type="radio">外部</label></dd>
                 </dl>                  
                 <dl class="fmdl fmmr fmmm">
                   <dt>业务分类：</dt>
                   <dd>
              ...
              <div class="searchbox_hidden">
                <dl class="fmdl fmmr fmmm">
                  <dt>文件来源：</dt>
                  <dd><label for=""><input type="radio">不限</label></dd>
                  <dd><label for=""><input type="radio">缺失</label></dd>
                  <dd><label for=""><input type="radio">外部</label></dd>
                </dl>                  
                <dl class="fmdl fmmr fmmm">
                  <dt>档案状态：</dt>
                  <dd><label for=""><input type="radio">不限</label></dd>
                  <dd><label for=""><input type="radio">缺失</label></dd>
                  <dd><label for=""><input type="radio">已上传</label></dd>
                  <dd><label for=""><input type="radio">已签署</label></dd>
                </dl>                  
                <dl class="fmdl fmmr fmmm">
                  <dt>存储类型：</dt>
                  <dd><label for=""><input type="radio">不限</label></dd>
                  <dd><label for=""><input type="radio">文档</label></dd>
                  <dd><label for=""><input type="radio">图片</label></dd>
                  <dd><label for=""><input type="radio">音视频</label></dd>
                </dl>                  
                <dl class="fmdl fmmr fmmm clearfix">
                  ...
                  <dd><a href="javascript:;" class="pubbtn bluebtn">查询</a></dd>
                </dl>
              </div>
...
<!-- 接触访谈信息 -->
          ...
          <!--表格内容-->
            <table width="100%" cellspacing="0" cellpadding="0" class='table_l'>
                  ...
                  <tbody>
                      <tr>
                          <td>会议日期：<span>2016-01-26</span></td>
                          <td rowspan="3">访谈有效，沟通愉快！</td>
                      </tr>
                      <tr>
                          <td class="noborder">访谈对象：<span>CEO</span></td>
                          <td></td>
                          <td></td>
                      </tr>
                      <tr>
                          <td class="noborder">会议录音：<a href="#" class="blue">会议录音.mp3</a></td>
                          <td></td>
                          <td></td>
                      </tr>                  
                      <tr>
                          <td>会议日期：<span>2016-01-26</span></td>
                          <td rowspan="3"><span>访谈有效，还有三个问题需要解决。</span></td>
                      </tr>
                      <tr>
                          <td class="noborder">访谈对象：<span>CEO</span></td>
                          <td></td>
          ...
          <!--表格内容-->
            <table width="100%" cellspacing="0" cellpadding="0" class='table_l'>
                  ...
                  <tbody>
                      ...
                      <tr>
                          <td class="noborder red">会议结论：<span>否决</span></td>
                          <td></td>
                          <td></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                          <td class="noborder green">会议结论：<span>通过</span></td>
                          <td></td>
                          <td></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                          <td class="noborder">会议结论：<span>待定</span></td>
                          <td></td>
                          <td></td>
                      </tr>
                      <tr>
...
<!-- CEO评审信息 -->
          <div class="block" data-tab="con">
            ...
            <div class="btnbox_f btnbox_f1 btnbox_m clearfix">
                <a href="javascript:;" class="pubbtn fffbtn lpubbtn">添加会议记录</a>
                <a href="javascript:;" class="pubbtn fffbtn lpubbtn">立项会排期</a>
            </div>
...
<!-- 立项会信息 -->
          ...
          <div class="block" data-tab="con">
            ...
            <div class="btnbox_f btnbox_f1 btnbox_m clearfix">
                ...
                <a href="javascript:;" class="pubbtn fffbtn lpubbtn">更新投资意向书</a>
