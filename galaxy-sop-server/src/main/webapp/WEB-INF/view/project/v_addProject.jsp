        		...
        		<div class="page on clearfix" data-btn="page0">
                    ...
                    <ul class="basic_ul">
                        ...
                        <li>
                            ...
                            <span>
                            	<textarea class="new_nputr text" name="remark" maxlength="50" placeholder="最多输入50字" valType="OTHER" allowNULL="yes" regString="^.{0,50}$" msg="<font color=red>*</font>不能超过50字符"></textarea>
                        	</span>
                        </li>
                    </ul>  
                    <div class="new_r_compile new_bottom_color">
                    ...
                    <ul class="basic_ul">
                        <li>
                            ...
                            <span class="m_r15">
                            	<input type="text" class='new_nputr_number' id="formatContribution" name="formatContribution" allowNULL="no" valType="LIMIT_NUMBER" msg="<font color=red>*</font>支持两位小数"/>
                            </span>
