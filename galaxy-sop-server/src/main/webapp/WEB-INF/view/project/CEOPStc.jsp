...
<div class="meetingtc">
	<div class="top clearfix">
        ...
        <dl class="fmdl clearfix">
            <dt>会议召开日期：</dt>
            <dd>
            	<input class="form-control" type="date" id="CEO_meetingDateStr" />
            </dd>
        </dl>
    </div>
    ...
    <div class="min clearfix">
        ...
        <dl class="fmdl clearfix">
            <dt>会议结论：</dt>
            <dd class="clearfix">
                <label><input type="radio" name="CEO_meetingResult" value="meetingResult:1"/>通过</label>
                <label><input type="radio" name="CEO_meetingResult" value="meetingResult:2"/>待定</label>
                <label><input type="radio" name="CEO_meetingResult" value="meetingResult:3"/>否决</label>
            </dd>
        </dl>
    </div>
    ...
    <dl class="fmdl clearfix">
       <dt>会议纪要:</dt>
       <dd>
       	  <div type="text/plain" id="CEO_meetingNotes" style="width:100%;height:100px;"></div>
		</dd>
      </dl>
    ...
    <dl class="fmdl clearfix">
        ...
        <div class="fmload clearfix">
            <dd>
	        	<input type="text" name="fileName" id="CEO_fileName" class="txt" readonly="readonly"/>
	        </dd>
	        <dd>
	        	<a href="javascript:;" class="pubbtn fffbtn" id="CEO_file-select-btn">上传录音</a>
    		</dd>
        </div>
