        ...
        <div class="new_ul_all new_top_color">
          <table>
            ...
            <tr>
             ...
             <tr>
              <td>净利润：</td>
              <td><input type="text" name="formatProfitCost" class="txt new_nputr" value="<fmt:formatNumber value="${operationalData.profitCost}" pattern="#.##" minFractionDigits="2" > </fmt:formatNumber>" allowNULL="yes" valType="OTHER" regString="^((-[1-9](?:\d{0,9}\.\d{0,2}))|(-[0](?:\d{0}\.\d{0,2}))|(-[1-9](\d{0,9}))|([1-9](?:\d{0,9}\.\d{0,2}))|([0](?:\d{0}\.\d{0,2}))|([1-9](\d{0,9}))|0)$" msg="<font color=red>*</font>0到9999999999.99之间的两位小数">元</td>
