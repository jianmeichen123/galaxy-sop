 	...
 	<div class="ritmin">
    	...
    	<div class="new_tit_b">
        	<dl class="fmdl fmmt clearfix">
              <dt>运营数据统计区间：</dt>
              <dd>
               <input type="text" class="datepicker txt time" readonly="" id="startTime" name="operationIntervalDateStr" style="height:23px;">
              </dd>
          </dl>
          <dl class="fmdl fmmt clearfix">
              <dd class="clearfix">
      ...
      <div class="tabtable_con_on operationalInfo">
        ...
        <div class="new_ul_all new_top_color">
          <table>
            <tr>
              <td>员工人数：</td>
              <td><input type="text" name="employNum" class="txt new_nputr">个</td>
              <td>当月在职员工数（所有需要开工资的人数）</td>
            </tr>
            <tr>
              <td>分站（店）数量：</td>
              <td><input type="text" name="branchNum" class="txt new_nputr">个</td>
              <td>截至当月结束已经开设的分站或分店数量</td>
            </tr>
            <tr>
              <td>产品进度：</td>
              <td><input type="text" name="formatProductProcess" class="txt new_nputr">%</td>
        ...
        <div class="new_ul_all new_top_color">
          <table>
            <tr>
              <td>员工工资：</td>
              <td><input type="text" name="formatSalary" class="txt new_nputr">元</td>
              <td>当月需要支出的员工工资金额，如9月提交的是8月的工资金额</td>
            </tr>
            <tr>
              <td>房租水电网：</td>
              <td>
                <input type="text" name="formatOtherCoat" class="txt new_nputr">元
            ...
            <tr>
              <td>管理费用：</td>
              <td><input type="text" name="formatManageCost" class="txt new_nputr">元</td>
              <td>差旅、办公用品、应酬、快递等费用</td>
            </tr>
             <tr>
              <td>市场费用：</td>
              <td><input type="text" name="formatMarketCost" class="txt new_nputr">元</td>
              <td>用于产品宣传推广的支出金额</td>
            </tr>
             <tr>
              <td>业务运营费用：</td>
              <td><input type="text" name="formatOperatingCost" class="txt new_nputr">元</td>
              <td>用于产品运营的支出费用，如活动、用户激励、促销成本等</td>
            </tr>
             <tr>
              <td>生产成本：</td>
              <td><input type="text" name="formatProductionCost" class="txt new_nputr">元</td>
              <td>用于产生产品或服务的“制造”费用，如食材、原料、货价、上游采购等</td>
            </tr>
             <tr>
              <td>交易额：</td>
              <td><input type="text" name="formatTradeCost" class="txt new_nputr">元</td>
              <td>当月产生的交易额</td>
            </tr>
             <tr>
              <td>收入：</td>
              <td><input type="text" name="formatIncomeCost" class="txt new_nputr">元</td>
              <td>当月产生的收入额</td>
            </tr>
             <tr>
              <td>净利润：</td>
              <td><input type="text" name="formatProfitCost" class="txt new_nputr">元</td>
              <td>当月进账金额减所有应支付金额</td>
            </tr>
             <tr>
              <td>账面余额：</td>
              <td><input type="text" name="formatAccountBalance" class="txt new_nputr">元</td>
              <td>还剩多少钱</td>
            </tr>
          </table>
        </div>
        ...
        <div class="new_ul_all new_top_color">
          <table>
            <tr>
              <td>总用户数：</td>
              <td><input type="text" name="userNum" class="txt new_nputr">个</td>
              <td>累计app、网站注册用户数、微博微信关注数</td>
            </tr>
            <tr>
              <td>新增用户数：</td>
              <td><input type="text" name="userNew" class="txt new_nputr">个</td>
              <td>当月新增累积app、网站注册用户数、微博微信关注数</td>
            </tr>
            <tr>
              <td>月活跃用户数：</td>
              <td><input type="text" name="userActiveMonth" class="txt new_nputr">个</td>
              <td>当月登陆用户数</td>
            </tr>
            <tr>
              <td>月均日活跃用户数：</td>
              <td><input type="text" name="userActiveDay" class="txt new_nputr">个</td>
              <td>日登陆用户数的月平均数</td>
            </tr>
            <tr>
              <td>购买用户数：</td>
              <td><input type="text" name="userBuy" class="txt new_nputr">个</td>
              <td>当月产生的购买用户数</td>
            </tr>
            <tr>
              <td>在线商户数：</td>
              <td><input type="text" name="userOnline" class="txt new_nputr">个</td>
              <td>当月共有多少提供服务的商户在线、共有多少个SKU，C2C模式填提供服务方</td>
            </tr>
             <tr>
              <td>新增商户数：</td>
              <td><input type="text" name="businessNew" class="txt new_nputr">个</td>
              <td>当月新增商户数量、新增SKU数量，C2C模式填提供服务方</td>
            </tr>
             <tr>
              <td>购买商户数：</td>
              <td><input type="text" name="businessBuy" class="txt new_nputr">个</td>
              <td>有多少商户产生了购买，C2C模式填提供服务方</td>
            </tr>
             <tr>
              <td>成交订单数：</td>
              <td><input type="text" name="tradeOrders" class="txt new_nputr">单</td>
              <td>当月成交订单数</td>
            </tr>
             <tr>
              <td>平均成交单价：</td>
              <td><input type="text" name="formatTradeOrderBlance" class="txt new_nputr">元</td>
              <td>成交额／成交单量</td>
            </tr>
             <tr>
              <td>平均成交客单价：</td>
              <td><input type="text" name="formatTradeUserBlance" class="txt new_nputr">元</td>
              <td>成交额／成交人数（商户数）</td>
            </tr>
          </table>
        </div>
