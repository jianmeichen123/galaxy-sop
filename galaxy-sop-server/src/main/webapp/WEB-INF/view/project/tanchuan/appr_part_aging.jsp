	                ...
	                <dl class="fmdl fl_l  clearfix">
	                 ...
	                 <dl class="fmdl fl_l  clearfix">
		                ...
		                <dd>
		                	...
		                	<div class='moeny_all'>
		                    	<input class=" txt " name="grantMoney" id="grantMoney" data-name="field3" data-type="19" type="text" value="" required data-rule-verify_96="true"  data-msg-verify_96="<font color=red>*</font>金额最大允许输入9位整数和6位小数"/>
