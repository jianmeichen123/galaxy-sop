	            ...
	            <dl class="fmdl fl_l  clearfix">
	               ...
	               <input type="hidden" id="grantId" data-name="id" name="id" value=""/>
		            ...
		            <dt>实际注资名称 ：</dt>
		                <dd>
		                	<div>
		                    	<input class="edittxt" id="grantDetail" data-name="field1" data-type="19" oninput="change(event)" onporpertychange="change(event)" type="text" placeholder="实际" maxLength="20" valType="OTHER" regString="^.{0,20}$" msg="<font color=red>*</font>只能输入20个字符"/>
		                    </div> 
		                </dd>
		            </dl>
	                <dl class="fmdl fl_l  clearfix">
