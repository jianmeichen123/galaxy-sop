	                ...
	                <dl class="fmdl fl_l  clearfix">
	                 ...
	                 <dl class="fmdl fl_l  clearfix">
		                ...
		                <dd>
		                	...
		                	<div class='moeny_all'>
		                    	<input class=" txt " name="grantMoney" id="grantMoney" data-name="field3" data-type="19" type="text" value="" oninput="change(event)" onporpertychange="change(event)" required data-rule-verify_96="true"  data-msg-verify_96="<font color=red>*</font>支持9位长度的6位小数"/>
