	    ...
	    <div class="form clearfix">
	        <div class="edit_actual" id="info">
                ...
                <dl class="fmdl fl_l  clearfix">
	                ...
	                <dd>	
	                	<div id="setValue">
	                    	<input class=" txt " type="text" id="grantMoney"  name="grantMoney"  valType="OTHER" regString="^(([1-9])|(0\.\d*[1-9])|[1-9][0-9]{1,8}|([1-9][0-9]{1,8}\.[0-9]{1,2}))$" msg="<font color=red>*</font>支持9位长度的两位小数">
