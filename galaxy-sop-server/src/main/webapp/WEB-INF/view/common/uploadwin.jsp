...
<!--          	<input type="hidden" id="fileWorkTypeId"/> -->
        ...
        <dd>
        	<label><input type="checkbox" id="isProve"/>签署凭证</label>
        </dd>
    </dl>
    <dl class="fmdl clearfix">
    	<dt>所属项目：</dt>
        <dd>
        	<input type="text" id="sopProjectId" data-tid=""  class="txt"/>
        </dd>
        <dd><a class="searchbtn null" id="searchProjectBtn" href="javascript:;">搜索</a></dd>
    </dl>
