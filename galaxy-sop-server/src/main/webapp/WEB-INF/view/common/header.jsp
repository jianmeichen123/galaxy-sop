...
<div class="header clearfix">
    ...
    <div class="min clearfix">
        ...
        <div class="usermsg clearfix">
            ...
            <a href="http://fx.qa.galaxyinternet.com/sop" class="work">待办任务<em class="totalUrgent"></em></a>
            <a href="http://fx.qa.galaxyinternet.com/sop" class="work">紧急任务<em class="bubble"></em></a>
