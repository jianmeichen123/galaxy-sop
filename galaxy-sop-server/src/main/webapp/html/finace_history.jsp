    ...
    <div class="qualifications_all">
        ...
        <div class="conference_all">
            ...
            <dl class="fmdl clearfix sign_fmdl">
             <dt>投资金额：</dt>
                <dd>
                    &nbsp;<span class="fr">万元</span><input type="text" class="txt fl" name="field3" allowNULL="yes"  data-rule-verify_96="true" data-msg-verify_96="<font color=red>*</font>金额最大允许输入9位整数和6位小数"/>
                </dd>
