	    ...
	    <div class="form clearfix" id="actual_aging_container">
	        <div class="appr_aging">
	                <dl class="fmdl fl_l  clearfix">
		                <dt>计划注资名称：</dt>
		                <dd>
		                    	<input class=" txt "  name="field1" type="text" placeholder="分拨" maxlength="20"/>
		                </dd>
		            </dl>
	                <dl class="fmdl fl_l  clearfix">
		                <dt>计划注资时间 ：</dt>
	                 ...
	                 <dl class="fmdl fl_l  clearfix">
		                ...
		                <dd>
		                	...
		                	<div class='moeny_all'>
		                    	<input class=" txt " id="field3" name="field3" type="text" value="" required data-rule-verify_96="true"  data-msg-verify_96="<font color=red>*</font>支持9位长度的6位小数"/>
