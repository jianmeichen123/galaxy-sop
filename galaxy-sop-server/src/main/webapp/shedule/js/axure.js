...
(function($){
	...
	*/
	$.popup = function(options){
		...
		function popEve(){
			...
			this.strpop = "<div id=\"powindow\" class=\"pop\"  data-id=\"popid"+$(".pop").length+"\"><a href=\"javascript:;\" data-close=\"close\" class=\"close null33\">关闭</a><div class=\"poptxt\"><p class='popwait'>数据加载中，请稍候...</p></div></div>";
		...
		popEve.prototype = {
			...
			mousedrag:function(){
				var _this = this;
				$(_this.id).on("dblclick",function(){  //dblclick  mousedown
					var $self = $(this);   
					//弹层zindex
					$(".pop").removeClass("popzx");
					$self.addClass("popzx");
	...
	*/
	$.fn.calendar = function(options){
		...
		//修改密码验证
	$.fn.change_password = function(options){
		var strm;
		var reg_pass=/^(?=.*?[a-zA-Z])(?=.*?[0-6])[!"#$%&'()*+,\-./:;<=>?@\[\\\]^_`{|}~A-Za-z0-9]{8,100}$/;    
