	...
	$.Validator.match=function(para) {
		...
		var defaultVal = {
			...
			CHINESE : "^([\u4E00-\uFA29]|[\uE7C7-\uE7F3])*$",
			URL : "^http[s]?://[\\w\\.\\-]+$",
			LIMIT_11_NUMBER : "^(0(?:[.](?:[1-9]\\d{0,3}|0[1-9]0{0,2}|0[1-9]{2}0{0,1}|0[1-9]{3}|0{2}[1-9]0{0,1}|0{2}[1-9]{2}|0{3}[1-9]))|([1-9][0-9]{0,8})|([1-9][0-9]{0,8}\\.[0-9]{1,4}))$",
			LIMIT_13_NUMBER : "^(\\d(\\.\\d{1,4})?|([1-9][0-9]{1,12})(\\.\\d{1,4})?)$",
			LIMIT_10_NUMBER : "^(0(?:[.][0-9]{1,4})|([1-9][0-9]{0,8})|([1-9][0-9]{0,8}\\.[0-9]{1,4}|0))$",
...
//			不大于999999.9999
			LIMIT_6_NUMBER : "^(([0-9]{1,6})|([0-9]{1,6}\\.[0-9]{1,4}))$",
