        ...
        createLi: function() {
            ...
            this.$element.find('option').each(function() {
                ...
                if (!$this.data('content')) {
                    ...
                    text = icon + '<span class="text" data-value="'+$this.attr('value')+'" data-title-id="'+$this.attr('data-title-id')+'" data-type="'+$this.attr('data-type')+'">' + text + subtext + '</span>';
                }
        ...
        setSize: function() {
            ...
            if (this.options.size == 'auto') {
                var getSize = function() {
                    ...
                    menu.css({'max-height' : menuHeight-25 + 'px', 'overflow' : 'hidden', 'min-height' : minHeight + 'px'});
                    menuInner.css({'max-height' : menuHeight - headerHeight - searchHeight- menuPadding-25 + 'px', 'overflow-y' : 'auto', 'min-height' : minHeight - menuPadding + 'px'});
                };
                getSize();
