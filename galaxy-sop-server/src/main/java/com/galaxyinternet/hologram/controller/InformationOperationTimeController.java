...
public class InformationOperationTimeController extends BaseControllerImpl<InformationOperationTime,InformationOperationTime> {
	...
	private Map<String,Object> reflectData(String reflect){
		...
		switch(reflect){
		    ...
		    case "NO5" : reportType = 0;reflect = "competeTime";break;
		    case "ENO4": reportType = 1;reflect = "competeTime";break;
		    case "DNO5": reportType = 2;reflect = "competeTime";break;
		    case "GNO5": reportType = 5;reflect = "competeTime";break;
		    case "CNO4": reportType = 6;reflect = "competeTime";break;
		    case "ONO5": reportType = 7;reflect = "competeTime";break;
		    case "NO6" : reportType = 0;reflect = "stratagemTime";break;
		    case "DNO6": reportType = 2;reflect = "stratagemTime";break;
		    case "GNO6": reportType = 5;reflect = "stratagemTime";break;
		    case "ONO6": reportType = 7;reflect = "stratagemTime";break;
		    case "NO7" : reportType = 0;reflect = "financeTime";break;
		    case "DNO7": reportType = 2;reflect = "financeTime";break;
		    case "GNO7": reportType = 5;reflect = "financeTime";break;
		    case "ONO7": reportType = 7;reflect = "financeTime";break;
		    case "NO8" : reportType = 0;reflect = "lawTime";break;
		    case "DNO8": reportType = 2;reflect = "lawTime";break;
		    case "GNO8": reportType = 5;reflect = "lawTime";break;
		    case "ONO8": reportType = 7;reflect = "lawTime";break;
