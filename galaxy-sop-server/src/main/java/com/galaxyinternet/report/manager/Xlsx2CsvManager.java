...
public class Xlsx2CsvManager {
     ...
     */
    public Xlsx2CsvManager(OPCPackage pkg, PrintStream output, int minColumns) {
    ...
    public Xlsx2CsvManager(String inputFilePath, String outputFilePath) throws Exception {
...
//            this.output.println(sheetName + " [index=" + index + "]:");
    ...
    public static void main(String[] args) throws Exception {
    	Xlsx2CsvManager xlsx2csv = new Xlsx2CsvManager("c:\\test.xlsx", "c:\\outs.csv");
        xlsx2csv.process();
    }
