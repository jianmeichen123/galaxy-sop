...
UPDATE `fx_db`.`information_title` SET `placeholder`=null, `is_must`='0', `val_rule`='11', `val_rule_mark`='2' WHERE `id`='1810';
UPDATE `fx_db`.`information_title` SET `placeholder`=null, `is_must`='0', `val_rule`='11', `val_rule_mark`='2' WHERE `id`='1811';
UPDATE `fx_db`.`information_title` SET `placeholder`=null, `val_rule`='11', `val_rule_mark`='3' WHERE `id`='1903';
UPDATE `fx_db`.`information_title` SET `val_rule`='11', `val_rule_mark`='3' WHERE `id`='1548';
UPDATE `fx_db`.`information_title` SET `val_rule`='11', `val_rule_mark`='3' WHERE `id`='1303';
...
UPDATE `fx_db`.`information_title` SET `val_rule`='11', `val_rule_mark`='3' WHERE `id`='3022';
