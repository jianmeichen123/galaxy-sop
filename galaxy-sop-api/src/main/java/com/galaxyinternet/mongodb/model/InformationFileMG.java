...
public class InformationFileMG {
    ...
    private Map<String,List<InformationFileMG>> commonFileList;
	...
	public Map<String, List<InformationFileMG>> getCommonFileList() {
		return commonFileList;
	}

	public void setCommonFileList(Map<String, List<InformationFileMG>> commonFileList) {
