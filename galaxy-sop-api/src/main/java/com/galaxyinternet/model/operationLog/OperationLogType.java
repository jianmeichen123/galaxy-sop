...
public enum OperationLogType {
	...
	//认领任务-人事尽职调查
	UPLOAD_EQUITY_CLAIMT_SOPTASK_RS_JD("/galaxy/soptask/goClaimtcPage/"+UrlNumber.two, OperType.CLAIMT.getOperationType(), Target.DUE_DILIGENCE_RS_JD.getTargetName(),SopStage.TOUCH_INTERVIEW.getStageName()),
	//认领任务-财务尽职调查
	UPLOAD_EQUITY_CLAIMT_SOPTASK_CW_JD("/galaxy/soptask/goClaimtcPage/"+UrlNumber.three, OperType.CLAIMT.getOperationType(), Target.DUE_DILIGENCE_CW_JD.getTargetName(),SopStage.TOUCH_INTERVIEW.getStageName()),
	//认领任务-财务付款凭证
	...
	//认领任务-法务尽职调查
	UPLOAD_EQUITY_CLAIMT_SOPTASK_FW_JD("/galaxy/soptask/goClaimtcPage/"+UrlNumber.five, OperType.CLAIMT.getOperationType(), Target.DUE_DILIGENCE_FW_JD.getTargetName(),SopStage.TOUCH_INTERVIEW.getStageName()),
	//认领任务-法务工商变更
	...
	//完成任务-人事尽职调查
	UPLOAD_EQUITY_SUBMIT_SOPTASK_RS_JD("/galaxy/soptask/submitTask/"+UrlNumber.two, OperType.FINISH.getOperationType(), Target.DUE_DILIGENCE_RS_JD.getTargetName(),SopStage.TOUCH_INTERVIEW.getStageName()),
	//完成任务-财务尽职调查
	UPLOAD_EQUITY_SUBMIT_SOPTASK_CW_JD("/galaxy/soptask/submitTask/"+UrlNumber.three, OperType.FINISH.getOperationType(), Target.DUE_DILIGENCE_CW_JD.getTargetName(),SopStage.TOUCH_INTERVIEW.getStageName()),
	//完成任务-财务付款凭证
	...
	//完成任务-法务尽职调查
	UPLOAD_EQUITY_SUBMIT_SOPTASK_FW_JD("/galaxy/soptask/submitTask/"+UrlNumber.five, OperType.FINISH.getOperationType(), Target.DUE_DILIGENCE_FW_JD.getTargetName(),SopStage.TOUCH_INTERVIEW.getStageName()),
	//完成任务-法务工商变更
