...
public enum OperationMessageType
{
	...
	TRANSFER_PROJECT("/galaxy/projectTransfer/applyTransfer/"+UrlNumber.one,		MessageType.TRANSFER_PROJECT.getCode()),
	ASSIGN_PROJECT("/galaxy/projectTransfer/applyTransfer/"+UrlNumber.two,			MessageType.ASSIGN_PROJECT.getCode()),
